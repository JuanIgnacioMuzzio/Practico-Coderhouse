...
pytrends= TrendReq(hl='pt',retries=3, backoff_factor=20)
keywords = ["Clima", "Temperatura",'Chuva','Transito']
pytrends.build_payload(keywords, cat=0, timeframe='today 5-y', geo='BR', gprop='')

iot=pytrends.interest_over_time()    
iot

iot.drop(columns=['isPartial']).plot(kind='line',figsize=(8,6))

import psycopg2

url="data-engineer-cluster.cyhh5bfevlmn.us-east-1.redshift.amazonaws"
data_base="data-engineer-database"
user="ignaciomuzzio_coderhouse"
with open("D:\Juan Ignacio Muzzio\PROGRAMACION\Data Engeneer\pwd.txt",'r') as f:
    pwd= f.read()
